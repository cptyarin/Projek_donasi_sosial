    ...
    <div class="col-lg-8">
        <div class="card-mokapos">
            <div class="card-header">
                <i class="fas fa-edit me-2 text-warning"></i> Edit Program Donasi
            </div>
            <div class="card-body">
                <form action="{{ route('programs.update', $program) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control form-control-mokapos @error('nama_program') is-invalid @enderror" 
                               name="nama_program" value="{{ old('nama_program', $program->nama_program) }}" placeholder="Masukkan nama program donasi">
                        @error('nama_program')
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control form-control-mokapos @error('deskripsi') is-invalid @enderror" 
                                  name="deskripsi" rows="4" placeholder="Jelaskan tujuan dan manfaat program donasi ini">{{ old('deskripsi', $program->deskripsi) }}</textarea>
                        @error('deskripsi')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control form-control-mokapos @error('target_dana') is-invalid @enderror" 
                                   name="target_dana" value="{{ old('target_dana', $program->target_dana) }}" placeholder="0">
                            @error('target_dana')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-md-6 mb-3">
                            ...
                            @if($program->gambar)
                                <div class="mb-2">
                                    <img src="{{ asset('storage/'.$program->gambar) }}" style="max-height:80px;" class="rounded border">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="date" class="form-control form-control-mokapos @error('tanggal_mulai') is-invalid @enderror" 
                                   name="tanggal_mulai" value="{{ old('tanggal_mulai', $program->tanggal_mulai->format('Y-m-d')) }}">
                            @error('tanggal_mulai')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="date" class="form-control form-control-mokapos @error('tanggal_selesai') is-invalid @enderror" 
                                   name="tanggal_selesai" value="{{ old('tanggal_selesai', $program->tanggal_selesai->format('Y-m-d')) }}">
