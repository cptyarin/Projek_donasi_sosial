...
<head>
    ...
    <title>@yield('title', 'Sistem Donasi Sosial')</title>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    ...
                    @if(auth()->user()->isAdmin())
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ request()->routeIs('distributions.*') ? 'active' : '' }}" 
    ...
    <footer class="footer-mokapos">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li><a href="{{ route('donations.index') }}">Donasi</a></li>
            ...
            <div class="text-center">
                <small>&copy; {{ date('Y') }} DonasiSosial. All rights reserved.</small>
            </div>
        </div>
    </footer>
