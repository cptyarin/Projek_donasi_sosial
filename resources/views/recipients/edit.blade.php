    ...
    <div class="col-lg-8">
        <div class="card-mokapos">
            <div class="card-header">
                <i class="fas fa-edit me-2 text-warning"></i> Edit Penerima Bantuan
            </div>
            <div class="card-body">
                <form action="{{ route('recipients.update', $recipient) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control form-control-mokapos @error('nama') is-invalid @enderror" 
                               name="nama" value="{{ old('nama', $recipient->nama) }}" placeholder="Masukkan nama lengkap penerima">
                        @error('nama')
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control form-control-mokapos @error('alamat') is-invalid @enderror" 
                                  name="alamat" rows="3" placeholder="Masukkan alamat lengkap">{{ old('alamat', $recipient->alamat) }}</textarea>
                        @error('alamat')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control form-control-mokapos @error('no_hp') is-invalid @enderror" 
                                   name="no_hp" value="{{ old('no_hp', $recipient->no_hp) }}" placeholder="08123456789">
                            @error('no_hp')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control form-control-mokapos @error('kategori_bantuan') is-invalid @enderror" 
                                   name="kategori_bantuan" value="{{ old('kategori_bantuan', $recipient->kategori_bantuan) }}" placeholder="Sembako, Pendidikan, Kesehatan, dll">
